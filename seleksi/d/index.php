...
if (isset($_POST['lang'])) {
  ...
  if (file_exists($jsonFile)) {
      ...
      if ($jsonData !==false) {
        ...
        $home = translation("home",$data);
        $aboutUs = translation("about_us",$data);
        $contactUs = translation("contact_us",$data);
        $register = translation("register",$data);
        $login = translation("login",$data);
        $copyright = translation("copyright",$data);
      }
      else {
        $home = $en["home"];
        $aboutUs = $en["about us"];
        ...
        <ul>
          ...
          <li class="language-form">
            ...
            <select name="lang" id="lang" onchange="document.getElementById('langForm').submit()">
              <option selected <?php if (!isset($_POST['lang']) || $_POST['lang'] === "en" )echo "selected" ?> >English</option>
